...
Una sencilla aplicación de escritorio creada con Pygame y pokeapi que te permite buscar Pokémon por nombre o tipo, obtener sus datos de la PokeAPI y calcular la efectividad de tipo de su tipo primario contra un oponente especificado.

![Screenshot Placeholder](https://github.com/YinHeaven/Pekemon-multilinear-regression-efficiency-table/blob/main/img/pokeRLAI.jpeg)
